          ...
          <ul className="mb-6 md:mb-0">
            <li className="flex">
              ...
              <div className="ml-4 mb-4 flex flex-col space-y-4">
                <div>
                  <p className="font-bold">{CONTACT?.corporate?.name}:</p>
                  <p className="text-gray-600 ">{CONTACT?.corporate?.area1}</p>
                  <p className="text-gray-600 ">{CONTACT?.corporate?.area2}</p>
                </div>
                <div>
                  <p className="font-bold">{CONTACT?.branch?.name}:</p>
                  <p className="text-gray-600 ">{CONTACT?.branch?.area1}</p>
                  <p className="text-gray-600 ">{CONTACT?.branch?.area2}</p>
                </div>
              </div>
            </li>
            <li className="flex">
              ...
              <div className="ml-4 mb-4">
                ...
                <p className="text-gray-600 ">Mobile: {CONTACT?.mobile}</p>
                <p className="text-gray-600 ">Mail: {CONTACT?.mail}</p>
              </div>
            </li>
          </ul>
        </div>
